	...
	{"category":["ECG"],
	 ...
	 "report": [
		...
		{"search" : "Cardiomyopathy",
		 ...
		 "level" : [
			{"term": "Hypertrophic Cardiomyopthy" , "types":[]},
			{"term": "Restrictive Cardiomyopathy" , "types":[]},
			{"term": "Dilated Cardiomyopathy" , "types":[]},
			{"term": "Cardiomyopathy" , "types":[]},
			{"term": "Cardiomyopathy- Unspecified" , "types":[]}
		 ]			
		}
...
function check_comorb_in_sentences(impression_sentences, final_comorb, negPhrases_two_d, conjunctions_two_d){
	...
	//alert(negPhrases_two_d);
	//alert(conjunctions_two_d);	
	var i = 0, j = 0, k = 0;
...
function check(sentences,phrase)
{
	//alert("inside check");
	//alert("Checking for");
	//alert(phrase);
	//alert("in");
	//alert(sentences);
	final_sentences = check_comorb(sentences,phrase,negPhrases_two_d, conjunctions_two_d);
	//alert("final_sentences.... is...");
	//alert(final_sentences);
    if(final_sentences){
    	return 1;
    }
    else
...
function check_comorb(impression_sentences, final_comorb, negPhrases_two_d, conjunctions_two_d){
	//alert("Inside check_comorb");
	//alert(negPhrases_two_d);
	//alert(conjunctions_two_d);	
	var i = 0, j = 0, k = 0;
	var final_sentences = new Array();
	...
	//alert("Alert4");
	alert("Let's see what's returned");
	alert(final_sentences);
	return final_sentences;
}
