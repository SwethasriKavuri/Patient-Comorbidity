...
//var helpimg = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity3\\img\\help.png";
//var closeimg = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity3\\img\\close.png";
var divimg = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity3\\img\\div.png";
var divSingleimg = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity3\\img\\divSingle.png";
var arrowdownimg = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity3\\img\\arrow-down.gif";
var arrowupimg = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity3\\img\\arrow-up.gif";
var button1img = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity3\\img\\button1.jpg";
var menuimg1 = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity3\\img\\image001.png";
var menuimg2 = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity3\\img\\image002.png";
var menuimg3 = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity3\\img\\image003.png";
var menuimg4 = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity3\\img\\image004.png";
var menuimg5 = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity3\\img\\image005.png";
var menuimg6 = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity3\\img\\image006.png";
var menuimg7 = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity3\\img\\image007.png";
var menuimg8 = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity3\\img\\image008.png";
var menuimg9 = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity3\\img\\image009.png";
var menuimg10 = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity3\\img\\image010.png";
var menuimg11 = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity3\\img\\image011.png";
var menuimg12 = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity3\\img\\image012.png";
var menuimg13 = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity3\\img\\image013.png";
var menuimg14 = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity3\\img\\image014a.png";
var menuimg15 = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity3\\img\\image015a.png";
var menuimg16 = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity3\\img\\image016a.png";
var menuimg17 = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity3\\img\\image017a.png";
var menuimg18 = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity3\\img\\image018a.png";
...
function buildALheader() {
	var tableBody = "";
	tableBody += "<table width='100%' bgcolor='white'>"
			  + "<tr><td><br><p class='test' onclick='javascript:expandcollapse(\"alarrow\",\"albody\");'>Alerts&nbsp;&nbsp;"
			  + "<img id='alarrow' border='0' src='"+arrowdownimg+"' alt='Click to collapse' /></p></td></tr>"
			  + "</table>";
	$('#alheader').html(tableBody);
	return;
}

function buildALbody() {
	var tableBody = "";
	...
	var result = BPalert(maxsysBP, maxdiasBP, SYS_BP_MAX, DIAS_BP_MAX);
	
	if(result != 0) {
		tableBody += "<tr><td><table><tr><td>"
			  + "<span style='color: black;'>"
			  + "<input id='BPalert' type='checkbox' value='GROUP' onclick=\"unCheck('BPalert','BPalertChkGrp');\"/>Elevated Blood Pressure :"
			  + "</span>"
			  + "<br><div id='BPalertChkGrp' style='margin-left: 120px;'><table>"
			  + "<tr onmouseover=\"mouseOverPara('imageBPalSys','BPalSysCol');\" onmouseout=\"mouseOutPara('imageBPalSys','BPalSysCol')\">"
			  + "<td id='BPalSysCol'>";
		
		if(result == 1 || result == 3) {
			//tableBody += "<tr><td><span style='color: red;'>"
			//	+ "Systolic Blood Pessure: "+maxsysBP+" > "+SYS_BP_MAX
			//	+ "</span></td></tr>";
			tableBody += "<span style='color: blue;'>"
				  + "<input id='BPalertSys' type='checkbox' value='Systolic Blood Pessure' onclick=\"checkMain('BPalert','BPalertChkGrp');\">"
				  + "<a onmouseover=\"makeDivVisible('BPalSys');\" onmouseout=\"makeDivHidden('BPalSys')\">"
				  + "Systolic Blood Pessure&nbsp;&nbsp;</a></span>";
		}
		else {
			//tableBody += "<tr><td><span style='color: black;'>"
			//	+ "Systolic Blood Pessure: "+maxsysBP
			//	+ "</span></td></tr>";
		...
		tableBody += "</td>"
			  + "<td><a id='imageBPalSys' onmouseover=\"makeDivVisible('BPalSys');\" onmouseout=\"makeDivHidden('BPalSys');\" style='visibility: hidden;'> "
			  + "<img src='"+button1img+"' alt='Details'/></a></td>"
			  + "<td><div id='BPalSys' class='imageBackSingle' style='width:380px; height:300px; margin-top: -55px'><img src='"+divSingleimg+"' width='100%' height='100%'/>"
			  + "<div id='BPalSys' class='dynamicDiv' style='width:280px; height:230px; margin-left: 45px ; margin-top: -275px;'>"
			  + "<br><span style = 'color: #858384; font-weight: bold;'>"
			  + "Values are:<br><br></span>"
			  + "Systolic Blood Pessure: "+maxsysBP+" "+newMaxsysBPDate+'<br>'
			  + "<br><br><span style = 'color: #858384; font-weight: bold;'>"
			  + "Reference Rule:<br><br></span>"
			  + "Systolic Blood Pessure > "+SYS_BP_MAX+'<br>'
			  + "</div></div>"
			  + "</td></tr>"
			  + "<tr onmouseover=\"mouseOverPara('imageBPalDias','BPalDiasCol');\" onmouseout=\"mouseOutPara('imageBPalDias','BPalDiasCol')\" >"
			  + "<td id = 'BPalDiasCol'>";
		
		if(result == 2 || result == 3) {
			//tableBody += "<tr><td><span style='color: red;'>"
			//	+ "Diastolic Blood Pressure: "+maxdiasBP+" > "+DIAS_BP_MAX
			//	+ "</span></td></tr>";
			tableBody += "<span style='color: blue;'>"
				  + "<input id='BPalertDias' type='checkbox' value='Diastolic Blood Pessure' onclick=\"checkMain('BPalert','BPalertChkGrp');\">"
				  + "<a onmouseover=\"makeDivVisible('BPalDias');\" onmouseout=\"makeDivHidden('BPalDias')\">"
				  + "Diastolic Blood Pessure&nbsp;&nbsp;</a></span>";
		}
		else {
			//tableBody += "<tr><td><span style='color: black;'>"
			//	+ "Diastolic Blood Pressure: "+maxdiasBP
			//	+ "</span></td></tr>";
			tableBody += "<span style='color: black;'>"
				  + "<input id='BPalertDias' type='checkbox' value='Diastolic Blood Pessure' onclick=\"checkMain('BPalert','BPalertChkGrp');\">"
				  + "<a onmouseover=\"makeDivVisible('BPalDias');\" onmouseout=\"makeDivHidden('BPalDias')\">"
		...
		tableBody += "</td>"
			  + "<td><a id='imageBPalDias' onmouseover=\"makeDivVisible('BPalDias');\" onmouseout=\"makeDivHidden('BPalDias');\" style='visibility: hidden;'> "
			  + "<img src='"+button1img+"' alt='Details'/></a></td>"
			  + "<td><div id='BPalDias' class='imageBackSingle' style='width:380px; height:300px; margin-top: -55px'><img src='"+divSingleimg+"' width='100%' height='100%'/>"
			  + "<div id='BPalDias' class='dynamicDiv' style='width:280px; height:230px; margin-left: 45px ; margin-top: -275px;'>"
			  + "<br><span style = 'color: #858384; font-weight: bold;'>"
			  + "Values are:<br><br></span>"
			  + "Diastolic Blood Pessure: "+maxdiasBP+" "+newMaxdiasBPDate+'<br>'
			  + "<br><br><span style = 'color: #858384; font-weight: bold;'>"
			  + "Reference Rule:<br><br></span>"
			  + "Diastolic Blood Pessure > "+DIAS_BP_MAX+'<br>'
			  + "</div></div>"
			  + "</td></tr></table></div></td></tr></table></td></tr>";
	}
	
	//tableBody += "</table></td></tr></table>"
	//	+ "<table width='100%' bgcolor='white'><col width='50%'><col width='50%'><tr>"
	//	+ "<td style='text-align: right;'><button style='font-family:sans-serif;font-size:16px' onclick=''>Send Alert</button>"
	//	+ "</td><td></td></tr></table>";
...
var tableBody = "";
tableBody += "<table width='100%' bgcolor='white'>"
		  + "<tr><td><br><p class='test' onclick='javascript:expandcollapse(\"ccarrow\",\"ccbody\");'>CoMorbidities from Lab&nbsp;&nbsp;"
	...
	if (result != 0){
		...
		if (result == 3){
			tableBody += "<span style='color: blue;'>"
					  ...
					  + "<input type='checkbox' value='Kidney Injury:Chronic' onclick=\"checkMain('aki','akiChkGrp');\">"
					  + "Chronic&nbsp;&nbsp;</a></span>";
			} 
		else{
			tableBody += "<span style='color: black;'>"
...
if ($.inArray("^Kidney Injury^",pcArr) == -1){
	...
	if (result != 0){
		...
		tableBody += "<tr><td><table><tr><td>"
				  + "<span style='color: black'>"
				  + "<input type='checkbox' id='ckd' value='GROUP' onclick=\"unCheck('ckd','ckdChkGrp');\">Kidney Injury :</span>"
		...
		if (result == 2){
			tableBody += "<tr onmouseover=\"mouseOverPara('imageRfAcute','RfAcuteCol');\" onmouseout=\"mouseOutPara('imageRfAcute','RfAcuteCol');\">"
					  ...
					  + "<a onmouseover=\"makeDivVisible('RfAcute');\" onmouseout=\"makeDivHidden('RfAcute');\">"
					  + "<input type='checkbox' value='Kidney Injury:Acute' onclick=\"checkMain('ckd','ckdChkGrp');\">"
					  + "Acute&nbsp;&nbsp;</a></span>";
		}
		else{
			tableBody += "<tr onmouseover=\"mouseOverPara('imageRfAcute','RfAcuteCol');\" onmouseout=\"mouseOutPara('imageRfAcute','RfAcuteCol');\">"
		...
		tableBody += "</td>"
					  ...
					  + "Current Creatinine: "+maxcreatResult+" " + newmaxcreatDate +"<br>";
			...
			tableBody += "<br><span style='color: #858384; font-weight: bold;'> "
					  + "Determined by the Rule:<br><br></span>"
					  + "Current creatinine > " + creatHigh + "<br>"
					  + "and previous creatinine <=" + creatHigh + "<br>"
					  + "</div>"
					  + "</div>"
					  + "</td></tr>";
		...
		if (result == 3){
			tableBody += "<tr onmouseover=\"mouseOverPara('imageRfChronic','RfChronicCol');\" onmouseout=\"mouseOutPara('imageRfChronic','RfChronicCol');\">"
					  ...
					  + "<input type='checkbox' value='Kidney Injury:Chronic' onclick=\"checkMain('ckd','ckdChkGrp');\">"
					  + "Chronic&nbsp;&nbsp;</a></span>";
		}
		else{
			tableBody += "<tr onmouseover=\"mouseOverPara('imageRfChronic','RfChronicCol');\" onmouseout=\"mouseOutPara('imageRfChronic','RfChronicCol');\">"
		...
		if (result == 1){
			tableBody += "<tr onmouseover=\"mouseOverPara('imageRfChronicNOS','RfChronicNOSCol');\" onmouseout=\"mouseOutPara('imageRfChronicNOS','RfChronicNOSCol');\">"
					  ...
					  + "<input type='checkbox' value='Kidney Injury:NOS' onclick=\"checkMain('ckd','ckdChkGrp');\">"
					  + "Not Otherwise Specified&nbsp;&nbsp;</a></span>";
		}
		else{
			tableBody += "<tr onmouseover=\"mouseOverPara('imageRfChronicNOS','RfChronicNOSCol');\" onmouseout=\"mouseOutPara('imageRfChronicNOS','RfChronicNOSCol');\">"
