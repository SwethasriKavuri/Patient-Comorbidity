...
var divimg = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity_debug\\img\\div.png";
var divSingleimg = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity_debug\\img\\divSingle.png";
var arrowdownimg = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity_debug\\img\\arrow-down.gif";
var arrowupimg = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity_debug\\img\\arrow-up.gif";
var button1img = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity_debug\\img\\button1.jpg";
var menuimg1 = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity_debug\\img\\image001.png";
var menuimg2 = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity_debug\\img\\image002.png";
var menuimg3 = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity_debug\\img\\image003.png";
var menuimg4 = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity_debug\\img\\image004.png";
var menuimg5 = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity_debug\\img\\image005.png";
var menuimg6 = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity_debug\\img\\image006.png";
var menuimg7 = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity_debug\\img\\image007.png";
var menuimg8 = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity_debug\\img\\image008.png";
var menuimg9 = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity_debug\\img\\image009.png";
var menuimg10 = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity_debug\\img\\image010.png";
var menuimg11 = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity_debug\\img\\image011.png";
var menuimg12 = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity_debug\\img\\image012.png";
var menuimg13 = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity_debug\\img\\image013.png";
var menuimg14 = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity_debug\\img\\image014a.png";
var menuimg15 = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity_debug\\img\\image015a.png";
var menuimg16 = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity_debug\\img\\image016a.png";
var menuimg17 = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity_debug\\img\\image017a.png";
var menuimg18 = "\\\\unvrnynas\\unvrny\\c159\\WININTEL\\static_content\\uhmc_mp_comorbidity_debug\\img\\image018a.png";
...
if ($.inArray("^Acid Base Disorder^",pcArr) == -1){
	...
	if (result > 0){
		...
		tableBody += "<br><br><span style = 'color: #858384; font-weight: bold;'>"
				  ...
				  + "</div></div>"
				  + "</td></tr>"
				  + "<tr onmouseover=\"mouseOverPara('imageacdNOS','acdNOSCol');\" onmouseout=\"mouseOutPara('imageacdNOS','acdNOSCol')\">"
				  + "<td id ='acdNOSCol'>"
				  + "<span style='color: blue;'>"
				  + "<a onmouseover=\"makeDivVisible('acdnos');\" onmouseout=\"makeDivHidden('acdnos')\">"
				  + "<input type='checkbox' value='Acid Base Disorder:NOS' onclick=\"checkMain('acidbasedisorder','acdChkGrp');\"/>"
				  + "Not otherwise specified&nbsp;&nbsp;</a>"
				  + "</span></td>"
				  + "<td><a id='imageacdNOS' onmouseover=\"makeDivVisible('acdnos')\" "
				  + "onmouseout=\"makeDivHidden('acdnos');\" style='visibility: hidden;'>"
				  + "<img src='"+button1img+"' alt='Details'/></a></td>"
				  + "<td><div id='acdnos' class='imageBackSingle' style='width:"+tmpw+"px;height:"+tmph+"px;margin-top:"+tmpmt+"px'><img src='"+divSingleimg+"' width='100%' height='100%'/>"
				  + "<div id='acdnos' class='dynamicDiv' style='width:"+(tmpw-tmpml-tmpml)+"px;height:"+(tmph-35)+"px;margin-left:"+tmpml+"px;margin-top:-"+(tmph-15)+"px;'>"
				  + "<br><span style='color: #858384; font-weight: bold;'>"
				  + "Values are:<br><br></span>";
		if (isEmpty(minbicarbonate) != true){ tableBody += 'Serum Bicarbonate: <b>'+minbicarbonate+"</b> on "+minbicarbonateDate+'<br>'; }
		if (isEmpty(maxbicarbonate) != true){ tableBody += 'Serum Bicarbonate: <b>'+maxbicarbonate+"</b> on "+maxbicarbonateDate+'<br>'; }
		tableBody += "<br><br><span style = 'color: #858384; font-weight: bold;'>"
				  + "Determined by the Rule:<br><br></span>"
				  + "Serum Bicarbonate < 18 or > 30 mEq/l"
				  + "</div></div>"
				  + "</td></tr>"
				  + "</table></div></td><td></table></td></tr>";                    
		}
...
//	&& $.inArray("^Septic Shock^",pcArr) == -1){
	...
	if (result >= 2){
		...
		tableBody += "<tr><td><table><tr><td>"
				  ...
				  + "<img src='"+button1img+"' alt='Details'/></a></td>"
				  + "<td><div id='SIRSdtid' class='imageBackSingle' style='width:"+tmpw+"px;height:"+tmph+"px;margin-top:"+tmpmt+"px'><img src='"+divSingleimg+"' width='100%' height='100%'/>"
				  + "<div id='SIRSdtid' class='dynamicDiv' style='width:"+(tmpw-tmpml-tmpml)+"px;height:"+(tmph-45)+"px;margin-left:"+tmpml+"px;margin-top:-"+(tmph-20)+"px;'>"
				  + "<br><span style = 'color: #858384; font-weight: bold;'>"
				  + "Values are:<br><br></span>";
		...
		tableBody += "<br><br><span style='color: #858384; font-weight: bold;'>"
				  ...
				  + "</ul>"
				  + "*** noninfectious causes such as trauma, burn, pancreatitis, etc."
				  + "</div>"
				  + "</div>"
				  + "</td></tr>"
...
//************************************** Shock *******************************************
if ($.inArray("^Shock^",pcArr) == -1 && $.inArray("^Hypotension^",pcArr) == -1){
	...
	if (result > 0){
		...
		tableBody += "</div>"
				  ...
				  + "</div>"
				  + "</td></tr>"
				  + "<tr onmouseover=\"mouseOverPara('imageHypotension','ShockHypotension');\" onmouseout=\"mouseOutPara('imageHypotension','ShockHypotension');\">"
				  + "<td id = \"ShockHypotension\"><span style='color: blue;'>"
				  + "<a onmouseover=\"makeDivVisible('hypotension');\" onmouseout=\"makeDivHidden('hypotension');\">"
				  + "<input type='checkbox' value='Hypotension' onclick=\"checkMain('shock','shockChkGrp');\">"
				  + "Hypotension&nbsp;&nbsp;</a></span></td>"
...
if (comorb == "Anemia"){
	...
	tableBody += "<h2 align='center'>Kidney Injury</h2><br>"
			  + "<p align='center'>Following are the conditions for Kidney Injury:</p>"
			  + "<ul><li><p>Acute: if the current Creatinine value > Normal High from DB and previous Creatinine value < Normal High from DB</p></li>"
			  + "<li><p>Chronic: if the current Creatinine value > Normal High from DB and previous Creatinine value > Normal High from DB</p></li>"
			  + "<li><p>Acute on Chronic: if the current Creatinine value > Normal High from DB and previous Creatinine value > Normal High from DB</p></li>"
              + "<li><p>Not otherwise specified: When previous Creatinine value is not available and current Creatinine value > Normal high from DB </p></li></ul>";
	}
...
//			  + "<li>Urine Output last 8 hours <= 240cc</li>"
              + "<li>Lactic Acid value > accepted normal value</li></ul>";
	}
else if (comorb == "UTI"){
...
if (val.indexOf("^Acid Base Disorder:NOS^") > -1){
	comorbidities += "~Acid Base Disorder:NOS^";  
	if (isEmpty(minbicarbonate) != true){ comorbidities += ',Serum Bicarbonate: '+minbicarbonate + " on "+minbicarbonateDate; }
	if (isEmpty(maxbicarbonate) != true){ comorbidities += ',Serum Bicarbonate: '+maxbicarbonate + " on "+maxbicarbonateDate; }
	}
