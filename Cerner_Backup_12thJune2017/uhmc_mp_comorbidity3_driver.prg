...
drop program uhmc_mp_comorbidity3_driver:dba go
create program uhmc_mp_comorbidity3_driver:dba
...
if (domain = "P159" or domain = "p159")
    ...
    set StaticSourceDir = "\\unvrnynas\unvrny\c159\WININTEL\static_content\uhmc_mp_comorbidity3"
    set htmlfile = "uhmc_mp_comorbidity3.html"
endif
