...
variables['calciumLow'] = parseDouble(calciumLow);
variables['mincalciumResult'] = parseDouble(mincalciumResult);
...
var rb_result = processRules(ruleJSON, variables);
tableBody += "<table width='100%' bgcolor='white'><col width='10%'><col width='90%'><tr><td></td><td>"
...
if ($.inArray("^Acid Base Disorder^",pcArr) == -1){
	...
	if (flag){
		...
		tableBody += "<tr><td><table><tr><td>"
				  ...
				  + "<td id ='acdAcidCol'>";
		if (result['Metabolic Acidosis'] == true ){ tableBody += "<span style='color: blue;'>"; }
		else{ tableBody += "<span style='color: black;'>"; }
		...
		tableBody += "<br><br><span style = 'color: #858384; font-weight: bold;'>"
				  ...
				  + "<td id ='acdAlkaCol'>";
		if (result['Metabolic Alkalosis'] == true){ tableBody += "<span style='color: blue;'>"; }
		else{ tableBody += "<span style='color: black;'>"; }
...
if ($.inArray("^Kidney Injury^",pcArr) == -1){
    result = rb_result["Kidney Injury"];
	var flag = false;	
	if (typeof(result) == 'object') 
	{
		for (var inkey in result) 
	...
	if (flag){
		...
		tableBody += "<tr><td><table><tr><td>"
				  ...
				  + "<td id='RfAcuteCol'>";
		if (result["Acute"] == true){ tableBody += "<span style='color: blue;'>"; }
		else{ tableBody += "<span style='color: black;'>"; }
		...
		tableBody += "<br><br><span style = 'color: #858384; font-weight: bold;'>"
				  ...
				  + "<td id='RfChronicCol'>";
		if (result["Chronic"] == true){ tableBody += "<span style='color: blue;'>"; }
		else{ tableBody += "<span style='color: black;'>"; }
		...
		if (result["Acute on Chronic"] == true){ tableBody += "<span style='color: blue;'>"; }
		else{ tableBody += "<span style='color: black;'>"; }
		tmpw = 400;
		tmph = 260;
		tmpmt = -35;
		...
		tableBody += "<tr onmouseover=\"mouseOverPara('imageRfNOS','RfNOSCol');\" onmouseout=\"mouseOutPara('imageRfNOS','RfNOSCol');\">"
		  + "<td id='RfNOSCol'>";
		if (result["Not otherwise specified"] == true){ tableBody += "<span style='color: blue;'>"; }
		else{ tableBody += "<span style='color: black;'>"; }
		tmpw = 400;
		tmph = 260;
		tmpmt = -35;
...
if ($.inArray("^Malnutrition^",pcArr) == -1 && $.inArray("^Underweight^",pcArr) == -1){
	...
	if (flag){
		...
		if (result["Underweight"]==true){ tableBody += "<span style='color:blue;'>"; }
		else{ tableBody += "<span style='color:black;'>"; }
		...
		tableBody += "</td>"
				  ...
				  + "BMI: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>"+variables["malnutritionbmi"]+"</b><br>"
		...
		if (result["Mild"]==true){ tableBody += "<span style='color:blue;'>"; }
		else{ tableBody += "<span style='color:black;'>"; }
		...
		if (result["Moderate"]==true){ tableBody += "<span style='color:blue;'>"; }
		else{ tableBody += "<span style='color:black;'>"; }
		...
		if (result["Severe"]==true){ tableBody += "<span style='color:blue;'>"; }
		else{ tableBody += "<span style='color:black;'>"; }
...
if ($.inArray("^Morbid Obesity^",pcArr) == -1){
	result = rb_result['Morbid Obesity'];
	if (result == true){
		tmpw = 300;
		tmph = 260;
		tmpmt = -35;
...
if ($.inArray("^Elevated Blood Glucose^",pcArr) == -1){
	result = rb_result["Elevated Blood Glucose"]
	var flag = false;	
	if (typeof(result) == 'object') 
	{
		for (var inkey in result) 
	...
	if (flag == true){
		...
		if (result["Diabetes with Nephropathy"]==true){ tableBody += "<span style='color: blue;'>"; }
		else{ tableBody += "<span style='color: black;'>"; }
...
if ($.inArray("^Granulocytopenia^",pcArr) == -1){
	result = rb_result['Granulocytopenia']
	if (result == true){
		tmpw = 330;
		tmph = 220;
		tmpmt = -35;
...
if ($.inArray("^Lactic Acidosis^",pcArr) == -1){
	result = rb_result['Lactic acidosis'];
	if (result == true){
		tmpw = 330;
		tmph = 220;
		tmpmt = -35;
...
var result = rb_result["Electrolyte abnormality"];
var flag = false;	
	if (typeof(result) == 'object') 
	{
		for (var inkey in result) 
...
if (flag) {
var	result1 = result["Hypokalemia"],
	result2 = result["Hyperkalemia"],
	result3 = result["Hyponatremia"],
	result4 = result["Hypernatremia"],
	result5 = result["Hypocalcemia"],
	result6 = result["Hypercalcemia"],
	result7 = result["Hypophosphatemia"],
	result8 = result["Hyperphosphatemia"],
	result9 = result["Hypomagnesemia"],
	result10 = result["Hypermagnesemia"]
...
if ($.inArray("^Obesity^",pcArr) == -1){
	...
	if (result != 0){
		...
		tableBody += "<tr><td><table>"
				  ...
				  + "Height: &nbsp<b>"+minheight+"</b> on "+minheightDate+"<br>"
				  + "Weight: <b>"+maxweight+"</b> on "+maxweightDate+"<br>"
				  + "BMI: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>"+variables['obesitybmi']+"</b><br>"
				  + "<br><br><span style='color: #858384; font-weight: bold;'>"
				  + "Determined by the Rule:<br><br></span>"
				  + "BMI > 30 and < 40"
				  + "</div>"
...
// // // //************************************** UTI *******************************************
 if ($.inArray("^UTI^",pcArr) == -1){
	...
	{   
		for (var inkey in result) 
		{	  //alert("result[inkey]:"+result[inkey]);
			if (result[inkey]===true)
			{
				flag = true;
                //alert("UTI:true");
...
if ($.inArray("^Respiratory Failure^",pcArr) == -1){
	result = rb_result["Respiratory failure"];
	var flag = false;	
	if (typeof(result) == 'object') 
	{
		for (var inkey in result) 
...
if ($.inArray("^Shock^",pcArr) == -1){
	...
	if (flag){
		...
		tableBody += "<tr><td><table><tr><td>"
				  ...
				  + "<td id='CardShockCol2'>";
		if (result["Cardiogenic Shock"] == true){ tableBody += "<span style='color: blue;'>"; }
		else{ tableBody += "<span style='color: black;'>"; }
...
if ($.inArray("^HyperCholesterolemia^",pcArr) == -1){
	result = rb_result["HyperCholesterolemia"];
	if (result == true){
		tmpw = 390;
		tmph = 240;
		tmpmt = -35;
...
// var rb_result = processRules(ruleJSON, variables);
// //alert(rb_result['Respiratory failure'])	
// for(var i = 0; i < ruleJSON.length; i++) 
// {
	// var obj = ruleJSON[i];     
	// var key = Object.keys(obj)[0];
	// var foundclass = "style='color:blue'";
	// var flag = false;
	// var temp = "";
	
	// //tableBody += "<ul>";
	// if (typeof(rb_result[key]) == 'object') 
	// {
		// for (var inkey in rb_result[key]) 
		// {	
			// if (rb_result[key][inkey]===true)
			// {
				// flag = true;
				// newCC = 1;
				// temp += "<li "+foundclass+">"+inkey+"</li>";
			// }
		// }
		// if (flag)
		// {
			// tableBody += "<li>"+key+":</li><ul>";
			// tableBody += temp;
			// tableBody += "</ul>";
		// }				
	// }
	// else 
	// {
		// if (rb_result[key]===true)
		// {
			// newCC = 1;
			// tableBody += "<li "+foundclass+">"+key+"</li>"
		// }
	// }
	// //tableBody += "</ul>";
	// //alert(tableBody);
